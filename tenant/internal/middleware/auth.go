...
// Context keys injected by Auth middleware — used by handlers and RBAC middleware.
const (
...
// Exported so main.go can construct stub claims without circular imports.
type Claims struct {
...
// validateToken calls POST <authServiceURL>/validate with the bearer token
